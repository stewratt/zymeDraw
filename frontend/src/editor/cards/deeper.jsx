...
// canvas-proportioned Rect whose side handles are hidden, so only uniform
// corner scaling (and rotation) is possible. Orientation stays portrait —
// a live invariant (CLAUDE.md §8).
//
